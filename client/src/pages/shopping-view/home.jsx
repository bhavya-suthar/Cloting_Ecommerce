...
function ShoppingHome() {
  ...
  console.log("🚀 ~ ShoppingHome ~ slides:", slides);
  ...
  console.log("🚀 ~ ShoppingHome ~ productDetails:", productDetails)
  ...
  console.log("🚀 ~ ShoppingHome ~ currenSlide:", currenSlide);
  return (
      ...
      <div className="relative w-full h-[600px] overflow-hidden">
        {slides.map((slide, index) => (
          <img
            ...
            key={index}
            className={`${
              index === currenSlide ? "opacity-100" : "opacity-0"
        ...
        >
          <ChevronLeftIcon className="w-4 h-4 text-black hover:text-white" />
        </Button>
        <Button
          variant="outline"
          size="icon"
